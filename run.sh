...
curl -Lo /root/sb https://github.com/SagerNet/sing-box/releases/download/v1.3.1-beta.2/sing-box-1.3.1-beta.2-linux-amd64.tar.gz && tar -xzf /root/sb && cp -f /root/sing-box-*/sing-box /root && rm -r /root/sb /root/sing-box-* && chown root:root /root/sing-box && chmod +x /root/sing-box
...
systemctl restart --now sing-box && sleep 0.2 && systemctl status sing-box
